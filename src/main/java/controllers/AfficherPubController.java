...
public class AfficherPubController {
    ...
    private void chargerTerrains() {
        try {
            List<Publication> pubs = servicePublication.afficher();
    ...
    public void rafraichirAffichage() {
        try {
            List<Publication> terrains = servicePublication.afficher();
    ...
    public void supprimerTerrain() {
        ...
        if (result.isPresent() && result.get() == ButtonType.OK) {
            try {
                servicePublication.supprimer(pubSelectionne.getIdPub());
